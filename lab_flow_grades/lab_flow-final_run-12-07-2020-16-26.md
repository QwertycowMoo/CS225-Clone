...
This report was generated for **kjzhou2** using **d0aa59048c04a6f4cb7ab7dc2a60700ef1bdf15a** (latest commit as of **December 7th 2020, 6:00 am**)
...
==70== 
==70== HEAP SUMMARY:
==70==     in use at exit: 16 bytes in 1 blocks
==70==   total heap usage: 2,096 allocs, 2,095 frees, 244,552 bytes allocated
==70== 
==70== LEAK SUMMARY:
==70==    definitely lost: 0 bytes in 0 blocks
==70==    indirectly lost: 0 bytes in 0 blocks
==70==      possibly lost: 0 bytes in 0 blocks
==70==    still reachable: 16 bytes in 1 blocks
==70==         suppressed: 0 bytes in 0 blocks
==70== Reachable blocks (those to which a pointer was found) are not shown.
==70== To see them, rerun with: --leak-check=full --show-leak-kinds=all
==70== 
...
==72== 
==72== HEAP SUMMARY:
==72==     in use at exit: 16 bytes in 1 blocks
==72==   total heap usage: 2,076 allocs, 2,075 frees, 240,544 bytes allocated
==72== 
==72== LEAK SUMMARY:
==72==    definitely lost: 0 bytes in 0 blocks
==72==    indirectly lost: 0 bytes in 0 blocks
==72==      possibly lost: 0 bytes in 0 blocks
==72==    still reachable: 16 bytes in 1 blocks
