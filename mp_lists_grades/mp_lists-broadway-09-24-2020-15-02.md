...
==119==    at 0x4630B0: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==119==    by 0x440F8B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==119==    by 0x438668: void Catch::AssertionHandler::handleExpr<bool>(Catch::ExprLhs<bool> const&) (catch.hpp:1648)
==119==    by 0x4365E9: ____C_A_T_C_H____T_E_S_T____31() (tests_part1.cpp:243)
==119==    by 0x4728B2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==119==    by 0x463006: Catch::TestCase::invoke() const (catch.hpp:10793)
==119==    by 0x462F3C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==119==    by 0x45F496: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==119==    by 0x45DA6E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==119==    by 0x466E06: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==119==    by 0x465AA2: Catch::Session::runInternal() (catch.hpp:10149)
==119==    by 0x46576A: Catch::Session::run() (catch.hpp:10106)
==119== 
==119== 
==119== HEAP SUMMARY:
...
==121==    at 0x4630B0: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==121==    by 0x440F8B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==121==    by 0x438668: void Catch::AssertionHandler::handleExpr<bool>(Catch::ExprLhs<bool> const&) (catch.hpp:1648)
==121==    by 0x4368AE: ____C_A_T_C_H____T_E_S_T____33() (tests_part1.cpp:252)
==121==    by 0x4728B2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==121==    by 0x463006: Catch::TestCase::invoke() const (catch.hpp:10793)
==121==    by 0x462F3C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==121==    by 0x45F496: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==121==    by 0x45DA6E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==121==    by 0x466E06: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==121==    by 0x465AA2: Catch::Session::runInternal() (catch.hpp:10149)
==121==    by 0x46576A: Catch::Session::run() (catch.hpp:10106)
==121== 
==121== 
==121== HEAP SUMMARY:
...
==121== Use --track-origins=yes to see where uninitialised values come from
...
==124==    at 0x42ADF2: List<int>::print(std::__1::basic_ostream<char, std::__1::char_traits<char> >&) const (List-given.hpp:130)
==124==    by 0x439B83: ____C_A_T_C_H____T_E_S_T____2() (test_part2_extra.cpp:41)
==124==    by 0x4728B2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==124==    by 0x463006: Catch::TestCase::invoke() const (catch.hpp:10793)
==124==    by 0x462F3C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==124==    by 0x45F496: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==124==    by 0x45DA6E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==124==    by 0x466E06: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==124==    by 0x465AA2: Catch::Session::runInternal() (catch.hpp:10149)
==124==    by 0x46576A: Catch::Session::run() (catch.hpp:10106)
==124==    by 0x4656E9: Catch::Session::run(int, char**) (catch.hpp:10074)
==124==    by 0x492761: main (catch.hpp:13613)
==124== 
==124== 
==124== HEAP SUMMARY:
...
This report was generated for **kjzhou2** using **80c3433271dfd371baf4c931d8073896c3725742** (latest commit as of **September 24th 2020, 3:02 pm**)
